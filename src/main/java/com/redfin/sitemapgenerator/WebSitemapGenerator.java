...
public class WebSitemapGenerator extends SitemapGenerator<WebSitemapUrl, WebSitemapGenerator> {
     ...
     * @param   baseDir  Sitemap files will be generated in this directory as either "sitemap.xml" or "sitemap1.xml"
     ...
     * @return  a builder; call .build() on it to make a sitemap generator
     */
    public static SitemapGeneratorBuilder<WebSitemapGenerator> builder(final String baseUrl, final File baseDir)
    ...
    /**
     * Configures the generator with a base URL and a null directory. The object constructed is not intended to be used
     * to write to files. Rather, it is intended to be used to obtain XML-formatted strings that represent sitemaps.
     *
     * @param  baseUrl  All URLs in the generated sitemap(s) should appear under this base URL
     */
    public WebSitemapGenerator(final String baseUrl) throws MalformedURLException {
     ...
     * @param  baseUrl  All URLs in the generated sitemap(s) should appear under this base URL
     */
    public WebSitemapGenerator(final URL baseUrl) {
        this(new SitemapGeneratorOptions(baseUrl));
    }

    private static class Renderer extends AbstractSitemapUrlRenderer<WebSitemapUrl>
        implements ISitemapUrlRenderer<WebSitemapUrl> {
        ...
        public void render(final WebSitemapUrl url, final StringBuilder sb, final W3CDateFormat dateFormat) {
            final StringBuilder tagSb = new StringBuilder();
            for (final Alternate alternate : url.getAlternates()) {
                tagSb.append("    <xhtml:link rel=\"alternate\" hreflang=\"").append(alternate.getHreflang())
                     .append("\" href=\"").append(alternate.getUrl()).append("\" />\n");
            }
